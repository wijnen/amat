...
#define DBG_ENABLE
#else
// Alternative: disable debug output.
#endif
#endif
...
# Introduction
Amat (avr mega and tiny) is a system for building firmware for AVR devices made
...
include /usr/share/amat/amat.mk
```

# Source Code
The firmware source code needs to include `<amat.hh>`. Before that, it should
