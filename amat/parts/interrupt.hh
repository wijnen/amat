...
#endif
#else
#define AVR_INT0_MASK 0
#endif

/// Bitmask of all available external interrupt pins.
#define INT_MASK (AVR_INT0_MASK | AVR_INT1_MASK | AVR_INT2_MASK | AVR_INT3_MASK | AVR_INT4_MASK | AVR_INT5_MASK | AVR_INT6_MASK | AVR_INT7_MASK)
