...
/**
 * @file
 * Code for internal testing of amat
 *
...
namespace Usart {
	static inline bool tx_write(uint8_t c);
	static inline uint8_t rx_read(uint8_t pos);
	static inline void rx_pop(uint8_t num);
}
...
#endif
#if defined(_AVR_COUNTER1_HH) && defined(AVR_TEST_COUNTER1)
...
#endif
#if defined(_AVR_HSCOUNTER_HH) && defined(AVR_TEST_HSCOUNTER)
		Test::tx(Hscounter::testcode);
#endif
